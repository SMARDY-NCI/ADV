...
exp4.mdi.plots <- ggpubr::ggarrange(plotlist = plot.results.exp4, ncol = 2, nrow = 2,
                  font.label = list(size = 3, color = "black", face = "bold", family = NULL),
                  common.legend = TRUE)
DF.exp4.plots <- ggpubr::annotate_figure(exp4.mdi.plots, top = ggpubr::text_grob("Case II: Columnwise transformation - Dublin Footfall", color = "black", face = "bold", size = 12))
```
