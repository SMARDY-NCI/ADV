...
lsd.results <- lsdAnalysis(mdi.exp.data, factor1 = "Method", factor2 = "MDpctge", 
													 factor.color = "Method", graph.out = "curve", hier = T)
...
exp4.mdi.plots <- ggpubr::ggarrange(plotlist = plot.results.exp4$l.plots, ncol = 2, nrow = 2,
                  font.label = list(size = 3, color = "black", face = "bold", family = NULL))
                  # common.legend = TRUE)
DF.exp4.plots <- ggpubr::annotate_figure(exp4.mdi.plots, top = ggpubr::text_grob("Case IV: Removal of rows - Dublin Footfall (LSD intervals)",
                                       color = "black", face = "bold", size = 12))
```
