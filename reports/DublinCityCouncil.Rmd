...
pca_remrows <- vpca_removecells(data = dat, 4, ref.P = model.PCA$model$rotation, 
                               k_ho = 1000, rm_pctges = c(1,5,10,seq(20,80,by=20)))

autoencoder_remrows <- vae_removecells(data = dat, A, 
